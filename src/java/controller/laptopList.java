 ...
 * @author tran tung
 */
@WebServlet(name="laptopList", urlPatterns={"/laptoplist"})
public class laptopList extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet laptopList</title>");  
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet laptopList at " + request.getContextPath () + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    } 
    ...
    throws ServletException, IOException {
        ...
        List<model.dao.ProductLista> laptopList = pl.getLaptopList();
